    ...
    <Layout title="Dashboard Overview">
      <ErrorBoundary>
        <div className="space-y-8">
          ...
          {/* API Status Banner */}
          <div className={`rounded-lg p-4 ${isDemoMode ? 'bg-yellow-50 border border-yellow-200' : 'bg-green-50 border border-green-200'}`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className={`font-medium ${isDemoMode ? 'text-yellow-800' : 'text-green-800'}`}>
                    {isDemoMode ? 'Demo Mode Active' : 'Live API Connected'}
                  </h4>
                  <p className={`text-sm ${isDemoMode ? 'text-yellow-700' : 'text-green-700'}`}>
                    {isDemoMode 
                      ? 'Currently showing demo data. Configure Gravity Forms API for real-time monitoring.'
                      : 'Connected to MyComputerCareer Gravity Forms. Real-time data active.'
                    }
                  </p>
                </div>
              </div>
              ...
              >
                {isDemoMode ? 'Configure API' : 'View Monitoring'}
              </Link>
            </div>
          </div>
